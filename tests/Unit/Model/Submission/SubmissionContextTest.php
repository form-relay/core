...
class SubmissionContextTest extends TestCase
{
    ...
    {
        $this->subject = new SubmissionContext($values);
    ...
    {
        $this->subject = new SubmissionContext();
    ...
    public function setCookie()
    {
        ...
        $result = $this->subject->toArray();
        $this->assertEquals([SubmissionContext::NAMESPACE_COOKIES => ['key1' => 'value1']], $result);
    }
    ...
    public function addCookies()
    {
        ...
        $result = $this->subject->toArray();
        $this->assertEquals([SubmissionContext::NAMESPACE_COOKIES => ['key1' => 'value1', 'key2' => 'value2']], $result);
    }
    ...
    public function setRequestVariable()
    {
        ...
        $result = $this->subject->toArray();
        $this->assertEquals([SubmissionContext::NAMESPACE_REQUEST_VARIABLES => ['key1' => 'value1']], $result);
    }
    ...
    public function addRequestVariables()
    {
        ...
        $result = $this->subject->toArray();
        $this->assertEquals([SubmissionContext::NAMESPACE_REQUEST_VARIABLES => ['key1' => 'value1', 'key2' => 'value2']], $result);
    }
